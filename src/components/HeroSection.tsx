...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="min-h-screen bg-gradient-to-r from-[#159bc7] to-[#4968aa] dark:from-[#0f172a] dark:to-[#1e293b] flex items-center relative overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch min-h-screen">
          ...
          <div className="text-white animate-fade-in flex flex-col justify-center order-2 lg:order-1 text-center lg:text-left py-12 sm:py-16 lg:py-20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mb-8">
              <Button 
                size="lg" 
                className="bg-white text-blue-600 hover:bg-blue-50 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 font-tajwal text-base lg:text-lg px-6 lg:px-8 py-3 lg:py-4 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-2"
              >
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-2 border-white text-white bg-transparent hover:bg-white hover:text-blue-600 dark:border-gray-300 dark:hover:bg-gray-300 dark:hover:text-gray-900 font-tajwal text-base lg:text-lg px-6 lg:px-8 py-3 lg:py-4 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-2"
              >
          ...
          <div className="flex justify-center lg:justify-end items-end order-1 lg:order-2 animate-slide-in-right">
            <div className="relative w-full h-screen flex items-end justify-center lg:justify-end">
              <img
