      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex space-x-4 space-x-reverse">
              {[Facebook, Twitter, Linkedin, Instagram].map((Icon, index) => (
                <a 
                  key={index}
                  href="#" 
                  className="bg-gray-800 p-3 rounded-full hover:bg-gradient-to-r hover:from-[#159bc7] hover:to-[#4968aa] transition-all duration-300 hover:scale-110"
                  style={{
          ...
          <div className="animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <h3 className="text-xl font-bold mb-6 font-tajwal">
              {t('quickLinks')}
            </h3>
            <ul className="space-y-3">
              {[
                ...
                <li key={item.name}>
                  <a 
                    href={item.href} 
                    className="text-gray-300 hover:text-white transition-all duration-200 font-tajwal hover:translate-x-2 inline-block"
                    style={{
        ...
        {/* Bottom Bar */}
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center animate-fade-in" style={{ animationDelay: '0.6s' }}>
          <p className="text-gray-400 font-tajwal text-sm">
            © 2024 {t('allRightsReserved')}
          </p>
          <div className="flex space-x-6 space-x-reverse mt-4 md:mt-0">
            <a href="#" className="text-gray-400 hover:text-white text-sm transition-colors duration-200 font-tajwal">
